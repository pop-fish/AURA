...
parser.add_argument("--gt_path", nargs='+', default=['/home/zhangleheng/work/resshift2/ResShift/datasets/DIV2KVal/DIV2K_valid_HR'], help='the path of high-resolution images')
parser.add_argument("--save_dir", type=str, default='/home/zhangleheng/work/resshift2/ResShift/datasets/DIV2KVal/DIV2K_valid_LR', help='the save path of the training dataset.')
...
parser.add_argument("--epoch", type=int, default=300, help='decide how many epochs to create for the dataset.')
